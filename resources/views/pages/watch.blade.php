                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="yoast_breadcrumb hidden-xs"><span><span><a href="">Phim hay</a> » <span><a
                                            href="danhmuc.php">Mỹ</a> » <span class="breadcrumb_last" aria-current="page">The
                                            godzilla vs king kong</span></span></span></span></div>
                    </div>
                </div>
            </div>
        ...
        <main id="main-contents" class="col-xs-12 col-sm-12 col-md-8">
            <section id="content" class="test">
                <div class="clearfix wrap-content">
                    ...
                    {{-- <iframe width="100%" height="500" src="https://trailer.vieon.vn/Teaser_NguoiHobbit_DaiChienNamCanhQuan.mp4"
                    title="YouTube video player" frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen></iframe> --}}
                    <iframe width="100%" height="500" src="https://www.youtube.com/embed/odM92ap8_c0"
                        title="YouTube video player" frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowfullscreen></iframe>
                    ...
                    <div class="title-block">
                        ...
                        <div class="title-wrapper-xem full">
                            <h1 class="entry-title"><a href="" title="The Hobbit - Đại chiến năm cánh quân"
                                    class="tl">Godzilla vs. Kong</a></h1>
                        </div>
                    </div>
                            ...
                            <div role="tabpanel" class="tab-pane active server-1" id="server-0">
                                <div class="halim-server">
                                    <ul class="halim-list-eps">
                                        <a href="{{route('episode')}}" class=""><li class="halim-episode"><span
